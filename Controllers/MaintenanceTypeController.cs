...
namespace backend.Controllers
{
    ...
    public class MaintenanceTypeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaintenanceId,ListOfMaintenance,MechanicId")] MaintenanceType maintenanceType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaintenanceId,ListOfMaintenance,MechanicId")] MaintenanceType maintenanceType)
        {
